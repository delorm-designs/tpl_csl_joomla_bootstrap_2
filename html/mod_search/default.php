...
<form class="form-search" action="<?php echo JRoute::_('index.php');?>" method="post">
	<div class="search<?php echo $moduleclass_sfx ?>">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$button = '<input type="image" value="" class="button' . $moduleclass_sfx.'" onclick="this.form.searchword.focus();"/>';
				else :
					$button = '<button class="' . $moduleclass_sfx . ' button" onclick="this.form.searchword.focus();"></button>';
				endif;
			endif;
